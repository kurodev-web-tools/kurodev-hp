...
export const webProjects = [
  {
    ...
    details: ["104 templates", "カテゴリ別に探せる一覧", "プラン導線と継続改善"],
    status: "Active",
    href: "https://templates.kuro-lab.com/",
    linkLabel: "HP-portalを見る",
...
export const pricingItems = [
  { title: "新規サイト / LP制作", price: "HP-portal基準", body: "テンプレート活用時は HP-portal のプランを基準に確認できます。" },
  { title: "Web制作・改善", price: "¥150,000〜", body: "既存サイトの改善、追加調整、公開後の運用整理の目安です。" },
  { title: "軽量ツール化", price: "個別見積", body: "業務フローや管理用UIなど、必要な範囲に合わせて整理します。" }
];
