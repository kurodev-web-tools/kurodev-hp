export const aboutContactContent = {
  ja: {
    ...
    contact: {
      ...
      form: {
        ...
        turnstile: "認証を完了してから送信してください。",
        submit: "送信する",
        sending: "送信中…",
        privacyUnavailable: "プライバシー案内はTask 12で公開予定です。",
        privacyPurpose: "送信内容は問い合わせへの対応に使用します。",
        status: { idle: "", invalid: "入力内容を確認してください。最初のエラー項目へ移動しました。", turnstile: "認証を完了してください。認証欄へ移動しました。", sending: "送信しています。", success: "送信しました。内容を確認します。", error: "送信できませんでした。入力内容はこの画面に残っています。" },
        fallback: "フォームを利用できない場合は、入力内容を保持したまま、メールでお問い合わせください。"
      },
      pricing: {
  ...
  en: {
    ...
    contact: {
      ...
      form: { eyebrow: "Inquiry form", title: "Discuss a production project", body: "Complete the required fields and enter at least 20 characters. A reference URL is optional.", required: "Required", optional: "Optional", labels: { name: "Name or activity name", email: "Email address", category: "Inquiry category", referenceUrl: "Reference URL", message: "Inquiry details" }, placeholders: { name: "Activity name or your name", email: "name@example.com", category: "Choose a category", referenceUrl: "https://example.com", message: "Share the current situation, what you want to discuss, and anything already decided." }, messageGuidance: "Enter at least 20 characters.", turnstile: "Complete the verification before sending.", submit: "Send inquiry", sending: "Sending…", privacyUnavailable: "The Privacy page is scheduled for Task 12.", privacyPurpose: "Submitted details are used to respond to your inquiry.", status: { idle: "", invalid: "Review the fields below. Focus moved to the first error.", turnstile: "Complete the verification. Focus moved to the verification area.", sending: "Sending your inquiry.", success: "Your inquiry was sent and will be reviewed.", error: "The inquiry could not be sent. Your typed values remain on this page." }, fallback: "If the form is unavailable, keep your typed details here and contact us by email." },
